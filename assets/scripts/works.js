...
workLinks.forEach(function (workLink) {
  workLink.addEventListener('click', function () {
    let buttonIndex = workLinks.indexOf(workLink);
    let mobileImage = projects[buttonIndex]['img_mobile'];
    let desktopImage = projects[buttonIndex]['img_desktop'];
    let projectDescription = projects[buttonIndex]['description'];
    let projectLive = projects[buttonIndex]['liveLink'];
    let projectSource = projects[buttonIndex]['liveSource'];
    ...
    let wform1 = document.createElement('form');
    ...
    let wform2 = document.createElement('form');
    ...
    let wform3 = document.createElement('form');
    ...
    let wp1_text = document.createTextNode(projectDescription);
