const projects = [
  {
    ...
    techstack_desktop: ['Javascript', 'CSS', 'HTML', 'Git'],
    techstack_mobile: ['Javascript', 'CSS', 'HTML', 'Git'],
  },
  {
    projectAvailability: true,
    name: 'Budget App',
    ...
    techstack_desktop: ['Ruby on rails', 'PostgreSQL'],
    techstack_mobile: ['Ruby on rails', 'PostgreSQL'],
  },
  {
    projectAvailability: true,
    name: "Today's To Do",
  ...
  },
  {
    projectAvailability: true,
    name: 'Math Magicians',
    img_desktop: './assets/images/math_desktop.png',
    img_mobile: './assets/images/math_mobile.png',
    description: 'Math Magicians is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to ake simple calculations, or read a random math related quote',
    liveLink: 'https://jorgegoco.github.io/math-magicians/',
    liveSource: 'https://https://github.com/jorgegoco/math-magicians',
    techstack_desktop: ['Codekit', 'Github', 'Javascript', 'Bootstrap', 'Terminal', 'Codepen'],
    techstack_mobile: ['Ruby on rails', 'CSS', 'Javascript'],
  },
  {
